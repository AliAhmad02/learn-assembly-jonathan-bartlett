...
# There is a mistake in the book where the format is given as %d, which
# refers to a 32-bit value. We are using 64-bit values, so we need to
# pick %ld or %lld
scanformat:
  .ascii "%ld %ld\0"

resultformat:
  .ascii "The result is %ld.\n\0"
